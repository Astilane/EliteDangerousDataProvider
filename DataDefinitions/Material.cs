...
namespace EddiDataDefinitions
{
    ...
    public class Material
    {
        ...
        public static readonly Material CrystalShards = new Material("crystalshards", "Manufactured", "Eclat de cristal", Rarity.VeryCommon);
        ...
        public static readonly Material ConductivePolymers = new Material("conductivepolymers", "Manufactured", "Conducteurs en polymères", Rarity.Rare);
        public static readonly Material ConfigurableComponents = new Material("configurablecomponents", "Manufactured", "Composant paramétrables", Rarity.Rare);
        ...
        public static readonly Material BiotechConductors = new Material("biotechconductors", "Manufactured", "Conducteurs biotechniques", Rarity.VeryRare);
        ...
        public static readonly Material ExquisiteFocusCrystals = new Material("exquisitefocuscrystals", "Manufactured", "Cristaux de focalisation sans défaut", Rarity.VeryRare);
        public static readonly Material ImperialShielding = new Material("imperialshielding", "Manufactured", "Protection impériale", Rarity.VeryRare);
        ...
        public static readonly Material MilitaryGradeAlloys = new Material("militarygradealloys", "Manufactured", "Alliages militaires", Rarity.VeryRare);
